#!/usr/bin/env python3
"""
IMPORTADOR DE CATÁLOGO PIEZAUTO - Hito 2 v5.3
Procesa archivos XLSX normalizados del COO y los carga en Supabase

VERSIÓN 5.3: RECONEXIÓN AUTOMÁTICA para evitar timeout total Supabase
- Reconecta cada 50 batches (~5000 SKUs o ~35 min de conexión)
- Timeout Supabase: 40 min → margen de seguridad 5 min
...
def ingestar_proveedor(filepath: Path, nombre_proveedor: str) -> EstadisticasIngesta:
    ...
    try:
        ...
        for batch_num in range(total_batches):
            ...
            # v5.3: RECONEXIÓN cada 50 batches para evitar timeout de Supabase (~35 min)
        ...
        if skus_hijos_pre_armados:
            ...
            for batch_num in range(total_batches_hijos):
                ...
                # v5.3: RECONEXIÓN cada 50 batches
                if batch_num > 0 and batch_num % 50 == 0:
