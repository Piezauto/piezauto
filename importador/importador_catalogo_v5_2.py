#!/usr/bin/env python3
"""
IMPORTADOR DE CATÁLOGO PIEZAUTO - Hito 2 v5.2
Procesa archivos XLSX normalizados del COO y los carga en Supabase

VERSIÓN 5.2: BATCHES ULTRA-REDUCIDOS para evitar timeouts Supabase
- Batches: 250 → 100 SKUs
- Delay: 1seg → 2seg entre batches
- Mismo formato PZ-XXXXXX (6 dígitos) con ORDER BY numérico de v5.1
